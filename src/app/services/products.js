export const productos = [
    {
      ...
      images: ['/s2c/1.webp', '/s2c/2.webp', '/s2c/3.webp'],
    ...
    },
    {
      ...
      qualityDescription:'Trabajamos con excelentes materiales para brindar una calidad superior logrando la mayor durabilidad del mercado Sillones y mesas ratonas con maderas tratadas (no pallets descartables, no tacos)',
      measures: [
        'Sillón dos cuerpos: 1,0 m x 60 cm',
        'Mesa ratona: 1,0 m x 50 cm'
      ],
      images: ['/2sym/1.webp', '/2sym/2.webp', '/2sym/3.webp'],
    ...
    },
    {
      ...
      images: ['/3sym/1.webp', '/3sym/2.webp', '/3sym/3.webp'],
      tags: ['sillón', 'madera tratada', 'exterior'],
    },
    {
      id: 4,
      ...
      measures: '80 x 40 x 40, 38L',
      images: ['/huerta/1.webp', '/huerta/2.webp', '/huerta/3.webp'],
      tags: ['huerta elevada', 'huerta', 'plantas',],
    },
  ];